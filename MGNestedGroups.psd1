#
# Module manifest for module 'MGNestedGroups'
#
# Generated by: Ole Rand-Hendriksen
#
...
Copyright = '(c) Ole Rand-Hendriksen. All rights reserved.'
...
RequiredModules = @(@{ModuleName = 'Microsoft.Graph.Users'; ModuleVersion = '2.6.1'; }, 
               @{ModuleName = 'Microsoft.Graph.Groups'; ModuleVersion = '2.6.1'; }, 
               @{ModuleName = 'Microsoft.Graph.Applications'; ModuleVersion = '2.6.1'; })
...
FunctionsToExport = 'Add-MGSubgroupsToEnterpriseApp', 'Get-MGSubgroups', 
               'Grant-LicenseToMGSubgroups', 'Revoke-LicenseFromMGSubgroups', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'Improved efficiency of the Get-MGSubGroups function'
